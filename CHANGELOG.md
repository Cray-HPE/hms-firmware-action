...
- Fixed indentation in values.yaml file
...
- Increment FAS version to rebuild the release/shasta-1.4 branch and pull in security updates.
...
- Update FAS CT image test to accept arbitrary firmware targets
...
- Resolve the locking failure where it doesnt release

## [1.5.5] - 2021-02-03

- Bump chart version to fix 1.4 release branch builds for CT tests.

## [1.5.4] - 2021-01-19

- Changed S3_ENDPOINT from s3_endpoint to fw_s3_endpoint

## [1.5.3] - 2020-12-08

- v1.4 fix only to remove persist images CASMHMS-4222
