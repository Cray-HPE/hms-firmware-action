...
- Created a check for an aborted stored action when storing action.
...
- Sets flag on restart which will trigger a restart of doVerify to continue checking for valid firmware updates.
