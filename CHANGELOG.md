...
- Bug fix to allow Giagbyte stage of "Downloading" to not cause failed update status.
...
- Upgrade service chart to 2.8.1
- set user to 65534
...
- Added task checking for iLO and update information for Gigabyte nodes
